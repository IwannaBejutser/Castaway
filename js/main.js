...
/* harmony import */ var _components_validations__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/validations */ "./src/js/components/validations.js");
...
/* eslint-disable */
console.log(...oo_oo(`3003451719_6_0_6_26_4`, (0,_functions_mobile_check__WEBPACK_IMPORTED_MODULE_0__.mobileCheck)()));
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](".rating__content", {
  slidesPerView: 1,
  spaceBetween: 40,
  centeredSlides: true,
  breakpoints: {
...
const afterForm = () => {
  /* eslint-disable */console.log(...oo_oo(`1292484507_32_2_32_68_4`, "Произошла отправка, тут можно писать любые действия"));
};
(0,_functions_validate_forms__WEBPACK_IMPORTED_MODULE_0__.validateForms)(".order__form", rules1, afterForm);
/* eslint-disable */
;
function oo_cm() {
  try {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        if (xhr.status === 200) {
          ...
          /* eslint-disable */
          console.log(...oo_oo(`1677565728_54_10_54_35_4`, 'Отправлено'));
        }
      }
    };
